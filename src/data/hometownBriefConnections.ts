...
export const HOMETOWN_BRIEF_ARTICLES: HometownBriefArticle[] = [
  ...
  },
  {
    ...
    title: 'The Economics of Production Leverage: Agent Hourly Value Analysis',
    ...
    readTime: '5 MIN READ',
    actionCta: 'READ THE BRIEF →',
    theBriefTakeaway: 'An agent closing 18 files spends hundreds of hours per year on administrative paperwork. By delegating contract-to-close at $375 per file, the agent buys back valuable production time to reinvest into client-facing activities and lead generation.',
    legalCitation: 'Hometown TC Agent Leverage Model',
    placeholderTitle: 'The Economics of Production Leverage: Agent Hourly Value Analysis',
    placeholderShortSummary: 'Economic analysis of agent hourly rates and the production gains of delegating transaction paperwork.',
    placeholderActionCta: 'READ THE BRIEF →',
