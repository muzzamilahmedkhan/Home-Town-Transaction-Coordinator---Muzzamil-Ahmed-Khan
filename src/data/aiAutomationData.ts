...
export const AI_AUTOMATION_RESOURCES: AiAutomationItem[] = [
  {
    ...
    whatThisHelpsAgentDo: 'Feed raw Florida purchase contracts into ChatGPT, Claude, or Gemini to extract all critical deadlines, parties, escrow dates, and missing addenda with zero manual typing.',
...
function isWeekendOrHoliday(date) {
  ...
  },
  {
    ...
    whatThisHelpsAgentDo: 'A battle-tested step-by-step procedure guide for Florida Realtors and admin assistants to execute within the first 60 minutes of going under contract.',
